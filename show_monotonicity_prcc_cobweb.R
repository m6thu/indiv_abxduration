...
output1=get(load('runs/LHSdiff_frequency_1000_notzero_20Sep2019_1646BST.Rdata'))
output2=get(load('runs/LHSdiff_frequency_900_notzero_20Sep2019_1305BST.Rdata'))
...
prcc<-output2$prcc[[3]]$PRCC
x.samples=output2[['data']]
y.output=output2$res[,3,1]
