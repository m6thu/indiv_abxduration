...
output1=get(load('runs/LHSdiff_frequency_800_notzero_14Aug2019_1606BST.Rdata'))
output2=get(load('runs/LHSdiff_frequency_700_notzero_14Aug2019_1521BST.Rdata'))
