...
parameters <- list(
    ...
    c("qunif", list(min=3, max=20), "max.los"),       # mean.max.los; mean of length of stay (normal distribution)
    ...
    c("qunif", list(min=20,max=100), "abx.r"),               # abxr_kills = amount of s killed by broad spectrum abx r
