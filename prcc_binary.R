...
parameters <- list(
  ...
  c("qunif", list(min=0, max=0.4), "prop_R"),    #probability of initial carriage of resistant organisms
  ...
  c("qunif", list(min=0, max=0.000001), "pi_ssr"),            #probability of being transmitted r to ss (ss—> ssr)
  ...
  c("qunif", list(min=0.1, max=0.4), "p.r.day1"),          #probability of being prescribed broad spectrum antibiotic on day 1 of admission 
  c("qunif", list(min=3, max=21), "meanDur")           #mean duration of antibiotics (normal distribution) 
)
