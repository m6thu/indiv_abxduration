...
###### explore magnitude of difference in carrier prevalence in binary model ######
###################################################################################
...
parameters <- list(
  ...
  c("qunif", list(min=3, max=7), "max.los"),       #max.los; mean of length of stay (exponential distribution)
  c("qunif", list(min=0.6, max=0.8), "prop_R"),    #probability of initial carriage of resistant organisms
  ...
  c("qunif", list(min=0.3, max=0.301), "pi_ssr"),            #probability of being transmitted r to ss (ss—> ssr)
