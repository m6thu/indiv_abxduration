...
simple_0=get(load('runs/LHSdiff_simple_1100_zero21Sep2019_2140BST.Rdata'))
binary_0=get(load('runs/LHSdiff_binary_1100_zero_21Sep2019_2323GMT.Rdata'))
freq_0=get(load('runs/LHSdiff_frequency_1100_zero_22Sep2019_1646BST.Rdata'))
simple_not0=get(load('runs/LHSdiff_simple_1100_notzero21Sep2019_1937BST.Rdata'))
binary_not0=get(load('runs/LHSdiff_binary_1000_notzero_22Sep2019_0424GMT.Rdata'))
freq_not0=get(load('runs/LHSdiff_frequency_1100_notzero_22Sep2019_1423BST.Rdata'))
